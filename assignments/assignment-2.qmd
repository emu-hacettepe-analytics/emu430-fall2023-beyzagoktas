...
my_favs = c("Ölümlü Dünya", "Ölümlü Dünya 2", "G.O.R.A.", "Eyvah Eyvah", "Babam ve Oğlum")
kable((movies |> arrange(desc(Rating)) |> mutate(Rank = row_number()) |> filter(Title %in% my_favs)), caption = "My Favorites")
```
